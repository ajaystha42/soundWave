const products = [
  ...
  },
  {
    ...
    images: ["../media/beats-black.jpg", "../media/bose-black.jpg",
  "../media/beats-black.jpg", "../media/bose-white.jpg"],
    category: "HEADPHONE",
    quantity: 1,
  },
  {
    ...
    images: ["../media/beats-black.jpg", "../media/jbl-black.jpg",
    "../media/beats-black.jpg", "../media/jbl-blue.jpg",
    "../media/beats-black.jpg", "../media/jbl-white.jpg"
  ],
    category: "HEADPHONE",
    quantity: 1,
  },
  {
    ...
    images: ["../media/beats-black.jpg", "../media/logitech-black.jpg",
    "../media/beats-black.jpg", "../media/logitech-rose.jpg",
    "../media/beats-black.jpg", "../media/logitech-white.jpg"
  ],
    category: "HEADPHONE",
    quantity: 1,
  },
  {
    ...
    images: ["../media/beats-black.jpg", "../media/razer-green.jpg",
    "../media/beats-black.jpg", "../media/razer-greenpink.jpg",
    "../media/beats-black.jpg", "../media/razer-white.jpg"
  ],
    category: "HEADPHONE",
    quantity: 1,
  },
  {
    ...
    images: ["../media/beats-black.jpg", "../media/sony-black.jpg",
    "../media/beats-black.jpg", "../media/sony-blue.jpg",
    "../media/beats-black.jpg", "../media/sony-silver.jpg"
  ],
    category: "HEADPHONE",
    quantity: 1,
  },
